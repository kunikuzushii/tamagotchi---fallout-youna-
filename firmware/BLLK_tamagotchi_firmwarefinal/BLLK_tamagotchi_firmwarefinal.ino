  ...
  switch (currentScreen) {
    ...
    case SCREEN_SLEEP:
      if (
        ...
        currentPose = random(0, 2) ? POSE_NORMAL : POSE_RESTING;
        poseUntil = millis() + 1200;
        nextIdlePose = millis() + random(4000, 9000);
      }
      pet.energy += 15;
      pet.health += 3;
      pet.energy = clampStat(pet.energy);
